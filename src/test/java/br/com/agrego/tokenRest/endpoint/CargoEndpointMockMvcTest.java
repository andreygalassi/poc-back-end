...
public class CargoEndpointTest {
	...
	@Test
	public void deveRetornarStatusCode200QuandoListarCargoUsandoMock(){
	...
	@Test
	public void deveRetornarStatusCode200QuandoBuscaCargoPorIdUsandoMock(){
...
//		Assertions.assertThat(exc.getStatusCodeValue()).isEqualTo(404);
	...
	public void deveRetornarStatusCode400QuandoSalvarCargoComTituloNull() throws Exception{
		Cargo cargo = Cargo.newInstance(3l,null);
