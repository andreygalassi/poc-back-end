...
public abstract class AbstractJpaDAO<T extends Serializable> {
	...
	protected TypedQuery<Long> createQueryTotal(final String ql) {
		TypedQuery<Long> createQuery = getEntityManager().createQuery(ql, Long.class);
		return createQuery;
	}
	
	protected void preparaPaginacao(Query query, Pageable pageable) {
